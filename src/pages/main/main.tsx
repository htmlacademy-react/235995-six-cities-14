...
import { CardProvider } from '../../context/card-provider.tsx';
...
function MainPage ({offers}: MainProps): JSX.Element {
  ...
  const activeCardId = useCard().isActiveCard;
  const selectedPoint = offersByCity.filter((offer) => offer.id === activeCardId);
            ...
            <div className="cities">
              <div className="cities__places-container container">
                ...
                <div className="cities__right-section">
                  {<Map city={offersByCity[0].city.location} points={offersByCity} selectedPoint={selectedPoint}/>}
                </div>
              </div>
            </div>
            : <MainEmpty />}
